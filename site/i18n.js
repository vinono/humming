...
Next steps:
  ...
  .env.example`,
      ...
      'hero.tab.quickstart': 'Quick Start',
      'hero.tab.simulator': 'BFF Simulator',
      'hero.sim.routeLabel': 'Choose Route:',
      'hero.sim.sendBtn': 'Send Request',
      'hero.sim.clearBtn': 'Clear Logs',
      'hero.sim.statusLabel': 'Status',
      'hero.sim.node.client': 'Client',
      'hero.sim.node.plugins': 'Plugins',
      'hero.sim.node.core': 'BFF Core',
      'hero.sim.node.upstream': 'Upstream',
      'hero.sim.consoleLabel': 'Live BFF console logs',
      'ecosystem.configurator.title': 'Live Setup Builder',
      'ecosystem.configurator.subtitle': 'Select plugins to compose your BFF instance in real time:',
      'ecosystem.configurator.codeTitle': 'Generated config (src/main.ts)',
      'cli.terminal.tab.init': 'Init',
      'cli.terminal.tab.dev': 'Dev',
      'cli.terminal.tab.build': 'Build',
      'cli.terminal.btnRun': 'Run Command',
      'cli.terminal.btnCopy': 'Copy',
    },
    zh: {
...
下一步：
  ...
  .env.example`,
      ...
      'footer.readme': 'README',
      'footer.github': 'GitHub',
      'hero.tab.quickstart': '快速开始',
      'hero.tab.simulator': 'BFF 模拟器',
      'hero.sim.routeLabel': '选择路由:',
      'hero.sim.sendBtn': '发送请求',
      'hero.sim.clearBtn': '清空日志',
      'hero.sim.statusLabel': '状态',
      'hero.sim.node.client': '客户端',
      'hero.sim.node.plugins': '插件链',
      'hero.sim.node.core': 'BFF 内核',
      'hero.sim.node.upstream': '上游服务',
      'hero.sim.consoleLabel': 'BFF 实时运行日志',
      'ecosystem.configurator.title': 'BFF 实时构建器',
      'ecosystem.configurator.subtitle': '勾选官方插件，实时组装你的 BFF 实例：',
      'ecosystem.configurator.codeTitle': '生成的配置文件 (src/main.ts)',
      'cli.terminal.tab.init': '创建',
      'cli.terminal.tab.dev': '开发',
      'cli.terminal.tab.build': '构建',
      'cli.terminal.btnRun': '运行命令',
      'cli.terminal.btnCopy': '复制',
    },
  },
  docs: {
    en: {
